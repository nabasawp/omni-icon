 ...
 */
namespace OmniIconDeps\Symfony\Bridge\Twig\ErrorRenderer;
...
class TwigErrorRenderer implements ErrorRendererInterface
{
     ...
     */
    public function __construct(private Environment $twig, ?HtmlErrorRenderer $fallbackErrorRenderer = null, bool|callable $debug = \false)
    {
