...
use OmniIconDeps\Symfony\Component\HttpFoundation\File\UploadedFile;
use OmniIconDeps\Symfony\Component\HttpFoundation\Request;
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\MapQueryString;
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\MapRequestPayload;
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\MapUploadedFile;
...
use OmniIconDeps\Symfony\Component\HttpKernel\Exception\HttpException;
use OmniIconDeps\Symfony\Component\HttpKernel\Exception\NearMissValueResolverException;
use OmniIconDeps\Symfony\Component\HttpKernel\Exception\UnsupportedMediaTypeHttpException;
use OmniIconDeps\Symfony\Component\HttpKernel\KernelEvents;
use OmniIconDeps\Symfony\Component\Serializer\Exception\NotEncodableValueException;
use OmniIconDeps\Symfony\Component\Serializer\Exception\PartialDenormalizationException;
use OmniIconDeps\Symfony\Component\Serializer\Exception\UnexpectedPropertyException;
use OmniIconDeps\Symfony\Component\Serializer\Exception\UnsupportedFormatException;
...
use OmniIconDeps\Symfony\Component\Validator\Constraints as Assert;
use OmniIconDeps\Symfony\Component\Validator\ConstraintViolation;
use OmniIconDeps\Symfony\Component\Validator\ConstraintViolationList;
use OmniIconDeps\Symfony\Component\Validator\Exception\ValidationFailedException;
use OmniIconDeps\Symfony\Component\Validator\Validator\ValidatorInterface;
...
class RequestPayloadValueResolver implements ValueResolverInterface, EventSubscriberInterface
{
    ...
    private function mapQueryString(Request $request, ArgumentMetadata $argument, MapQueryString $attribute): ?object
    {
        ...
        return $this->serializer->denormalize($data, $argument->getType(), 'csv', $attribute->serializationContext + self::CONTEXT_DENORMALIZE + ['filter_bool' => \true]);
    }
    private function mapRequestPayload(Request $request, ArgumentMetadata $argument, MapRequestPayload $attribute): object|array|null
    {
        ...
        if (\is_array($data)) {
            return $this->serializer->denormalize($data, $type, 'csv', $attribute->serializationContext + self::CONTEXT_DENORMALIZE + ('form' === $format ? ['filter_bool' => \true] : []));
        }
        if ('form' === $format) {
