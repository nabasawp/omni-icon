 ...
 */
namespace OmniIconDeps\Symfony\Component\Routing\Attribute;
...
if (!class_exists(\OmniIconDeps\Symfony\Component\Routing\Annotation\Route::class, \false)) {
    class_alias(Route::class, \OmniIconDeps\Symfony\Component\Routing\Annotation\Route::class);
}
