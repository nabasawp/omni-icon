...
class Response
{
    ...
    public function sendHeaders(?int $statusCode = null): static
    {
        ...
        if ($informationalResponse && (!\function_exists('headers_send') && !\function_exists('OmniIconDeps\headers_send'))) {
     ...
     * @return $this
     */
    public function send(bool $flush = \true): static
    {
        $this->sendHeaders();
        $this->sendContent();
        if (!$flush) {
        ...
        } elseif (\function_exists('OmniIconDeps\litespeed_finish_request')) {
    ...
    {
        if (!\in_array($this->statusCode, [200, 203, 300, 301, 302, 404, 410], \true)) {
            return \false;
        }
    ...
    {
        return \in_array($this->statusCode, [201, 301, 302, 303, 307, 308], \true) && (null === $location ?: $location == $this->headers->get('Location'));
    }
    /**
    ...
    {
        return \in_array($this->statusCode, [204, 304], \true);
    }
    /**
