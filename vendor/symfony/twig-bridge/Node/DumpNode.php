...
{
    public function __construct(private LocalVariable|string $varPrefix, ?Node $values, int $lineno)
    {
        $nodes = [];
        if (null !== $values) {
            $nodes['values'] = $values;
    ...
    public function compile(Compiler $compiler): void
    {
        ...
        if (!$this->hasNode('values')) {
            ...
            $compiler->addDebugInfo($this)->write('\Symfony\Component\VarDumper\VarDumper::dump([' . "\n")->indent();
