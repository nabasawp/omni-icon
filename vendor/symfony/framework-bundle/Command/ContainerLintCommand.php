...
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\CheckAliasValidityPass;
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\CheckTypeDeclarationsPass;
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\ResolveFactoryClassPass;
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\ResolveParameterPlaceHoldersPass;
...
final class ContainerLintCommand extends Command
{
    ...
    {
        $this->setHelp('This command parses service definitions and ensures that injected values match the type declarations of each services\' class.')->addOption('resolve-env-vars', null, InputOption::VALUE_NONE, 'Resolve environment variables and fail if one is missing.');
    }
    ...
    private function getContainerBuilder(bool $resolveEnvVars): ContainerBuilder
    {
        ...
        if (!$file || !(new ConfigCache($file, \true))->isFresh()) {
