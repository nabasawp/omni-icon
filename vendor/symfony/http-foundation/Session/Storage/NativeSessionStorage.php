 ...
 */
namespace OmniIconDeps\Symfony\Component\HttpFoundation\Session\Storage;

use OmniIconDeps\Symfony\Component\HttpFoundation\Session\SessionBagInterface;
use OmniIconDeps\Symfony\Component\HttpFoundation\Session\Storage\Handler\StrictSessionHandler;
use OmniIconDeps\Symfony\Component\HttpFoundation\Session\Storage\Proxy\AbstractProxy;
use OmniIconDeps\Symfony\Component\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy;
...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    public function setOptions(array $options): void
    {
        ...
        foreach ($options as $key => $value) {
            if (\in_array($key, ['referer_check', 'use_only_cookies', 'use_trans_sid', 'trans_sid_hosts', 'trans_sid_tags', 'sid_length', 'sid_bits_per_character'], \true)) {
