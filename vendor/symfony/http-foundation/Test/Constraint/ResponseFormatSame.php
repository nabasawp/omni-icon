 ...
 */
namespace OmniIconDeps\Symfony\Component\HttpFoundation\Test\Constraint;
...
{
    public function __construct(private Request $request, private ?string $format, private readonly bool $verbose = \true)
    {
    }
