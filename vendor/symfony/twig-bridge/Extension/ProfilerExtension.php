...
use OmniIconDeps\Twig\Extension\ProfilerExtension as BaseProfilerExtension;
...
final class ProfilerExtension extends BaseProfilerExtension
{
    ...
    public function __construct(Profile $profile, private ?Stopwatch $stopwatch = null)
    {
