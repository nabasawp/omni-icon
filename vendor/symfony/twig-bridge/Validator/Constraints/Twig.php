...
use OmniIconDeps\Symfony\Component\Validator\Attribute\HasNamedArguments;
...
class Twig extends Constraint
{
    ...
    #[HasNamedArguments]
    public function __construct(public string $message = 'This value is not a valid Twig template.', public bool $skipDeprecations = \true, ?array $groups = null, mixed $payload = null)
    {
