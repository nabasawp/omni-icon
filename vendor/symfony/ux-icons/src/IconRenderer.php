...
final class IconRenderer implements IconRendererInterface
{
     ...
     */
    public function __construct(private readonly IconRegistryInterface $registry, private readonly array $defaultIconAttributes = [], private readonly array $iconAliases = [], private readonly array $iconSetsAttributes = [])
    {
    }
    /**
     * Renders an icon.
