...
use OmniIconDeps\Symfony\Component\DependencyInjection\Compiler\ValidateEnvPlaceholdersPass;
...
EOF
    ...
    private function getDocUrl(ExtensionInterface $extension, ContainerBuilder $container): ?string
    {
        ...
        return $configuration->getConfigTreeBuilder()->getRootNode()->getNode(\true)->getAttribute('docUrl');
    }
}
