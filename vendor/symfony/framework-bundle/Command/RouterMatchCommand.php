...
use OmniIconDeps\Symfony\Component\Console\Input\ArrayInput;
...
use OmniIconDeps\Symfony\Component\Routing\Matcher\TraceableUrlMatcher;
...
class RouterMatchCommand extends Command
{
     ...
     */
    public function __construct(private RouterInterface $router, private iterable $expressionLanguageProviders = [])
    {
        parent::__construct();
    }
