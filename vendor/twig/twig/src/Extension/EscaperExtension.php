...
use OmniIconDeps\Twig\FileExtensionEscapingStrategy;
use OmniIconDeps\Twig\Node\Expression\ConstantExpression;
use OmniIconDeps\Twig\Node\Expression\Filter\RawFilter;
use OmniIconDeps\Twig\Node\Node;
use OmniIconDeps\Twig\NodeVisitor\EscaperNodeVisitor;
use OmniIconDeps\Twig\Runtime\EscaperRuntime;
use OmniIconDeps\Twig\TokenParser\AutoEscapeTokenParser;
...
final class EscaperExtension extends AbstractExtension
{
    ...
    {
        return max(parent::getLastModified(), filemtime((new \ReflectionClass(EscaperRuntime::class))->getFileName()));
    }
    /**
