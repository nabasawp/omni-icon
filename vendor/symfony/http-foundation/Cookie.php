...
class Cookie
{
     ...
     */
    public static function create(string $name, ?string $value = null, int|string|\DateTimeInterface $expire = 0, ?string $path = '/', ?string $domain = null, ?bool $secure = null, bool $httpOnly = \true, bool $raw = \false, ?string $sameSite = self::SAMESITE_LAX, bool $partitioned = \false): self
    {
     ...
     */
    public function __construct(protected string $name, protected ?string $value = null, int|string|\DateTimeInterface $expire = 0, ?string $path = '/', protected ?string $domain = null, protected ?bool $secure = null, protected bool $httpOnly = \true, private bool $raw = \false, ?string $sameSite = self::SAMESITE_LAX, private bool $partitioned = \false)
    {
