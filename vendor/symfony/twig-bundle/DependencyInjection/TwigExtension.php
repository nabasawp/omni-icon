...
use OmniIconDeps\Symfony\Component\Form\AbstractRendererEngine;
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if ($container::willBeAvailable('symfony/form', Form::class, ['symfony/twig-bundle'])) {
            ...
            if (is_subclass_of(AbstractRendererEngine::class, ResetInterface::class)) {
                $container->getDefinition('twig.form.engine')->addTag('kernel.reset', ['method' => 'reset']);
            }
        }
        ...
        $container->getDefinition('twig')->replaceArgument(1, array_intersect_key($config, ['debug' => \true, 'charset' => \true, 'base_template_class' => \true, 'strict_variables' => \true, 'autoescape' => \true, 'cache' => \true, 'auto_reload' => \true, 'optimizations' => \true]));
