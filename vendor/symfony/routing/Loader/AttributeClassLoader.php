 ...
 */
namespace OmniIconDeps\Symfony\Component\Routing\Loader;

use OmniIconDeps\Symfony\Component\Config\Loader\LoaderInterface;
use OmniIconDeps\Symfony\Component\Config\Loader\LoaderResolverInterface;
use OmniIconDeps\Symfony\Component\Config\Resource\ReflectionClassResource;
use OmniIconDeps\Symfony\Component\Routing\Attribute\DeprecatedAlias;
use OmniIconDeps\Symfony\Component\Routing\Attribute\Route as RouteAttribute;
use OmniIconDeps\Symfony\Component\Routing\Exception\InvalidArgumentException;
use OmniIconDeps\Symfony\Component\Routing\Exception\LogicException;
...
abstract class AttributeClassLoader implements LoaderInterface
{
    ...
    public function __construct(protected readonly ?string $env = null)
    {
    }
    /**
    ...
    public function load(mixed $class, ?string $type = null): RouteCollection
    {
        ...
        if ($globals['env'] && !\in_array($this->env, $globals['env'], \true)) {
            return $collection;
        }
        $fqcnAlias = \false;
    ...
    {
        if ($attr->envs && !\in_array($this->env, $attr->envs, \true)) {
            return;
        }
