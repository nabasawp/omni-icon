...
use OmniIconDeps\Symfony\Component\Filesystem\Exception\IOException;
...
use OmniIconDeps\Symfony\Component\HttpKernel\RebootableInterface;
/**
...
class CacheClearCommand extends Command
{
    ...
    public function __construct(private CacheClearerInterface $cacheClearer, ?Filesystem $filesystem = null)
    {
        parent::__construct();
        ...
        if (null === $mounts) {
            ...
            if ('/' === \DIRECTORY_SEPARATOR && @is_readable('/proc/mounts') && $files = @file('/proc/mounts')) {
                foreach ($files as $mount) {
                    ...
                    if (!\in_array(array_pop($mount), ['vboxsf', 'nfs'], \true)) {
                        continue;
                    }
