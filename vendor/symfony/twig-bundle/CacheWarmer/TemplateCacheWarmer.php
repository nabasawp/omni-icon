 ...
 */
namespace OmniIconDeps\Symfony\Bundle\TwigBundle\CacheWarmer;
...
class TemplateCacheWarmer implements CacheWarmerInterface, ServiceSubscriberInterface
{
     ...
     */
    public function __construct(private ContainerInterface $container, private iterable $iterator, private ?CacheInterface $cache = null)
    {
    }
