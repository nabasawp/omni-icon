...
## [${version}] - ${currentDate}`;
  ...
  const unreleasedLinkPattern = /\[unreleased\]: https:\/\/github\.com\/nabasa-dev\/omni-icon\/compare\/(.+?)\.\.\.HEAD/;
  ...
  if (match) {
    ...
    content = content.replace(
      ...
      `[unreleased]: https://github.com/nabasa-dev/omni-icon/compare/${version}...HEAD`
    );
    ...
    if (linksSection) {
      ...
      const newVersionLink = `\n[${version}]: https://github.com/nabasa-dev/omni-icon/compare/${previousRef}...${version}`;
