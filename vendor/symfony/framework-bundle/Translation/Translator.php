 ...
 */
namespace OmniIconDeps\Symfony\Bundle\FrameworkBundle\Translation;
...
use OmniIconDeps\Symfony\Component\Translation\Exception\InvalidArgumentException;
use OmniIconDeps\Symfony\Component\Translation\Formatter\MessageFormatterInterface;
use OmniIconDeps\Symfony\Component\Translation\Translator as BaseTranslator;
/**
...
class Translator extends BaseTranslator implements WarmableInterface
{
     ...
     */
    public function __construct(protected ContainerInterface $container, MessageFormatterInterface $formatter, string $defaultLocale, protected array $loaderIds = [], array $options = [], private array $enabledLocales = [])
    {
        // check option names
