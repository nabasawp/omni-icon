...
use OmniIconDeps\Psr\Clock\ClockInterface;
use OmniIconDeps\Symfony\Component\HttpFoundation\Exception\ExpiredSignedUriException;
use OmniIconDeps\Symfony\Component\HttpFoundation\Exception\LogicException;
use OmniIconDeps\Symfony\Component\HttpFoundation\Exception\SignedUriException;
use OmniIconDeps\Symfony\Component\HttpFoundation\Exception\UnsignedUriException;
use OmniIconDeps\Symfony\Component\HttpFoundation\Exception\UnverifiedSignedUriException;
/**
...
class UriSigner
{
    ...
    {
        return strtr(rtrim(base64_encode(hash_hmac('sha256', $uri, $this->secret, \true)), '='), ['/' => '_', '+' => '-']);
    }
