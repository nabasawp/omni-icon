 ...
 */
namespace OmniIconDeps\Symfony\Bridge\Twig\Mime;
...
use OmniIconDeps\Symfony\Component\Mime\HtmlToTextConverter\DefaultHtmlToTextConverter;
use OmniIconDeps\Symfony\Component\Mime\HtmlToTextConverter\HtmlToTextConverterInterface;
use OmniIconDeps\Symfony\Component\Mime\HtmlToTextConverter\LeagueHtmlToMarkdownConverter;
...
final class BodyRenderer implements BodyRendererInterface
{
    ...
    public function __construct(private Environment $twig, private array $context = [], ?HtmlToTextConverterInterface $converter = null, private ?LocaleSwitcher $localeSwitcher = null)
    {
