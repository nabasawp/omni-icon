...
use OmniIconDeps\Doctrine\DBAL\Schema\Table;
use OmniIcon\Core\Database\DatabaseInterface;
use OmniIcon\Core\Database\Migration\Attributes\Migration;
use ReflectionClass;
use RuntimeException;
abstract class AbstractMigration implements \OmniIcon\Core\Database\Migration\MigrationInterface
{
    ...
    private function getMigrationAttribute(): Migration
    {
        if ($this->migration === null) {
            ...
            if ($attributes === []) {
                throw new RuntimeException('Migration class ' . static::class . ' must have a Migration attribute');
            }
