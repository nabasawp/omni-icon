...
use OmniIconDeps\Symfony\Component\HttpKernel\Fragment\FragmentHandler;
...
{
    public function __construct(private FragmentHandler $handler, private ?FragmentUriGeneratorInterface $fragmentUriGenerator = null)
    {
    }
    /**
     * Renders a fragment.
