...
use OmniIconDeps\Symfony\Component\HttpFoundation\HeaderUtils;
...
{
    public function __construct(private ?UrlGeneratorInterface $router = null, private ?int $httpPort = null, private ?int $httpsPort = null)
    {
    }
    /**
