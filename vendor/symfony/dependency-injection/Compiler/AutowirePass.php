...
use OmniIconDeps\Symfony\Component\DependencyInjection\Attribute\AutowireInline;
...
class AutowirePass extends AbstractRecursivePass
{
    ...
    public function __construct(private bool $throwOnAutowiringException = \true)
    {
            ...
            if ($checkAttributes) {
                ...
                foreach ($attributes as $attribute) {
                    ...
                    if ($attribute instanceof AutowireInline) {
                        ...
                        $definition = (new Definition($type))->setFactory('current')->setArguments([[$value]])->setLazy(\true);
                        if (!\is_array($lazy)) {
