...
class TranslationDebugCommand extends Command
{
    ...
    public function __construct(private TranslatorInterface $translator, private TranslationReaderInterface $reader, private ExtractorInterface $extractor, private ?string $defaultTransPath = null, private ?string $defaultViewsPath = null, private array $transPaths = [], private array $codePaths = [], private array $enabledLocales = [])
    {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($allMessages as $domain => $messages) {
            foreach (array_keys($messages) as $messageId) {
                ...
                if (!\in_array(self::MESSAGE_UNUSED, $states, \true) && $input->getOption('only-unused') || !\in_array(self::MESSAGE_MISSING, $states, \true) && $input->getOption('only-missing')) {
                    continue;
                }
                foreach ($fallbackCatalogues as $fallbackCatalogue) {
