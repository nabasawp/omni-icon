...
use OmniIconDeps\Symfony\Component\Validator\Mapping\Factory\LazyLoadingMetadataFactory;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\AttributeLoader;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\LoaderChain;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\LoaderInterface;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\XmlFileLoader;
use OmniIconDeps\Symfony\Component\Validator\Mapping\Loader\YamlFileLoader;
...
class ValidatorCacheWarmer extends AbstractPhpFileCacheWarmer
{
     ...
     */
    public function __construct(private ValidatorBuilder $validatorBuilder, string $phpArrayFile)
    {
