...
use OmniIconDeps\Symfony\Bridge\Twig\TokenParser\StopwatchTokenParser;
...
{
    public function __construct(private ?Stopwatch $stopwatch = null, private bool $enabled = \true)
    {
    }
