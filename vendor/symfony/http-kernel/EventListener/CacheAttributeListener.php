...
use OmniIconDeps\Symfony\Component\HttpFoundation\HeaderBag;
use OmniIconDeps\Symfony\Component\HttpFoundation\Request;
use OmniIconDeps\Symfony\Component\HttpFoundation\Response;
use OmniIconDeps\Symfony\Component\HttpKernel\Attribute\Cache;
...
class CacheAttributeListener implements EventSubscriberInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        if (!\in_array($response->getStatusCode(), [200, 203, 300, 301, 302, 304, 404, 410], \true)) {
