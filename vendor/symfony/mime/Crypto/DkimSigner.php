...
final class DkimSigner
{
     ...
     */
    public function __construct(string $pk, private string $domainName, private string $selector, private array $defaultOptions = [], string $passphrase = '')
    {
        ...
        $this->defaultOptions += ['algorithm' => self::ALGO_SHA256, 'signature_expiration_delay' => 0, 'body_max_length' => \PHP_INT_MAX, 'body_show_length' => \false, 'header_canon' => self::CANON_RELAXED, 'body_canon' => self::CANON_RELAXED, 'headers_to_ignore' => []];
    }
