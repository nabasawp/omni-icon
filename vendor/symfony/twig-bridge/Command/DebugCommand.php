...
class DebugCommand extends Command
{
    ...
    public function __construct(private Environment $twig, private ?string $projectDir = null, private array $bundlesMetadata = [], private ?string $twigDefaultPath = null, private ?FileLinkFormatter $fileLinkFormatter = null)
    {
        parent::__construct();
    }
    protected function configure(): void
    {
        $this->setDefinition([new InputArgument('name', InputArgument::OPTIONAL, 'The template name'), new InputOption('filter', null, InputOption::VALUE_REQUIRED, 'Show details for all entries matching this filter'), new InputOption('format', null, InputOption::VALUE_REQUIRED, \sprintf('The output format ("%s")', implode('", "', $this->getAvailableFormatOptions())), 'txt')])->setHelp(<<<'EOF'
