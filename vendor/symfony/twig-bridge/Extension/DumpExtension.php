...
use OmniIconDeps\Symfony\Bridge\Twig\TokenParser\DumpTokenParser;
...
{
    public function __construct(private ClonerInterface $cloner, private ?HtmlDumper $dumper = null)
    {
    }
