 ...
 */
namespace OmniIconDeps\Symfony\Component\Config\Builder;
...
use OmniIconDeps\Symfony\Component\Config\Definition\BooleanNode;
use OmniIconDeps\Symfony\Component\Config\Definition\Builder\ExprBuilder;
use OmniIconDeps\Symfony\Component\Config\Definition\ConfigurationInterface;
use OmniIconDeps\Symfony\Component\Config\Definition\EnumNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration): \Closure
    {
        ...
        $rootClass = new ClassBuilder('OmniIconDeps\Symfony\Config', $rootNode->getName(), $rootNode, \true);
...
{DEPRECATED_BODY
    ...
    return $this;
        ...
        $class->addMethod($node->getName(), $body, ['DEPRECATED_BODY' => $class->isRoot ? "\n    \$this->_hasDeprecatedCalls = true;" : '', 'DEPRECATED_ANNOTATION' => $class->isRoot ? " @deprecated since Symfony 7.4\n *" : '', 'PROPERTY' => $property->getName(), 'COMMENT' => $comment, 'DEFAULT' => $node->hasDefaultValue() ? ' = ' . var_export($node->getDefaultValue(), \true) : '']);
    }
