 ...
 * @internal
 */
#[AsCommand(name: 'ux:icons:import', description: 'Import icon(s) from iconify.design')]
final class ImportIconCommand extends Command
{
    ...
    {
        $this->addArgument('names', InputArgument::IS_ARRAY | InputArgument::REQUIRED, 'Icon name from ux.symfony.com/icons (e.g. "mdi:home")');
    }
