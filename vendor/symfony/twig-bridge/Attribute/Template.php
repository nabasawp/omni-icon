 ...
 */
namespace OmniIconDeps\Symfony\Bridge\Twig\Attribute;
...
class Template
{
     ...
     */
    public function __construct(public string $template, public ?array $vars = null, public bool $stream = \false, public ?string $block = null)
    {
    }
}
