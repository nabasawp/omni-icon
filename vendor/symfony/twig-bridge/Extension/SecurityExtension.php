...
use OmniIconDeps\Symfony\Component\Security\Acl\Voter\FieldVote;
...
use OmniIconDeps\Symfony\Component\Security\Core\Authorization\UserAuthorizationCheckerInterface;
use OmniIconDeps\Symfony\Component\Security\Core\Exception\AuthenticationCredentialsNotFoundException;
use OmniIconDeps\Symfony\Component\Security\Core\User\UserInterface;
use OmniIconDeps\Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator;
...
{
    public function __construct(private ?AuthorizationCheckerInterface $securityChecker = null, private ?ImpersonateUrlGenerator $impersonateUrlGenerator = null)
    {
    }
